/*************************************************************************
    ...
    one called MyFriend and one called FBFriends. Going through the code
    below you should be able to figure out what member functions are
    needed for each. Also, since FBFriends is holding dynamic memory you 
    will need to write the Big 3 for this class.

    	John Dolan	        Spring 2014     Ohio University EECS
...
int main(){
    ...
    string friendname, username, filename;
    int choice, choice2;
    bool cutout;
...
int menu2(){
	...
	cout << "2 - Insert a new or cut-out friend before this friend.\n";
	cout << "3 - Put a new or cut-out friend after this friend.\n";
