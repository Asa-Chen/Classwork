...
class Check{
    public:
		Check(Date d = Date(1,1,1900), std::string p = "VOID", int num = 1, double amt = 0);
...
std::ostream& operator << (std::ostream& outs, const Check& c); //In & out call the functions you write
